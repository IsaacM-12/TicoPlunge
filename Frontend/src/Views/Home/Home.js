      ...
      <div className="todo">
        <div className="container">
          <div className="colorback">
            <h1 className="titulo">¡TICO PLUNGE!</h1>
          ...
          <div className="esquina">
            <div className="card-principal">
              <a className="social-link1" href="https://www.instagram.com/ticoplunge?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank">
                <svg viewBox="0 0 16 16" className="bi bi-instagram"
              ...
              <a className="social-link3" href="https://api.whatsapp.com/message/NQD6MTRNSIW5N1?autoload=1&app_absent=0" target="_blank">
                <svg viewBox="0 0 16 16" className="bi bi-whatsapp"
                  fill="currentColor" height="16" width="16"
                  xmlns="http://www.w3.org/2000/svg">
              ...
              <a className="social-link2" href="https://www.facebook.com/profile.php?id=61553047905206" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1em"
                  height="1.1em"
